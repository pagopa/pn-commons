...
# export GITHUB_TOKEN=<your GH token with read oackage permission>
ARTIFACTS=(
  it.pagopa.tech.lollipop-consumer-java-sdk:core:1.0.0-RC5
  it.pagopa.tech.lollipop-consumer-java-sdk:http-verifier:1.0.0-RC5
  it.pagopa.tech.lollipop-consumer-java-sdk:assertion-rest-client-native:1.0.0-RC5
  it.pagopa.tech.lollipop-consumer-java-sdk:identity-service-rest-client-native:1.0.0-RC5
